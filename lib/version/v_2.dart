...
//       ),
//     );
//     updateComponentPosition(selectedComponent!.id, pos); // Clamp on add
//     notifyListeners();
//   }
...
//     debugPrint(
//       'Clamped position for ${c.type.displayName}: (${c.position.dx}, ${c.position.dy})',
//     );
//     notifyListeners();
//   }
...
//     'showGrid': showGrid,
//     'showDimensions': showDimensions,
//     'version': '2.0', // Updated version to indicate feet-based positions
//   };
...
//       final isLegacy = version == '1.0' || version == null;
//       components =
...
//   void _loadFromJson(BuildContext context) {
